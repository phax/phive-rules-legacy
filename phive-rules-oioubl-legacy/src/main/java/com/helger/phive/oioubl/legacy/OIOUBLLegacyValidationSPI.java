...
/**
 * SPI implementation that registers the legacy OIOUBL validation rules.
 *
 * @author Philip Helger
 */
@IsSPIImplementation
public final class OIOUBLLegacyValidationSPI implements IValidationRulesRegistrarSPI
{
  @NonNull
  @ReturnsMutableCopy
  public ICommonsList <DVRCoordinate> getAllPrerequisites ()
  {
    // Only the legacy OIOUBL 3.0.1 rules have prerequisites (the older OIOUBL 1.x rules have none)
  ...
  {
    OIOUBLValidationOlder.initOlderOIOUBL (aRegistry);
